...
export const VIP_PLANS: VipPlan[] = [
  {
    ...
    priceUSD: 5,
    durationDays: 30,
    benefits: ['+5 bonus energy/day', '6x tap damage', '1.05x game multiplier', '2 cooldown resets'],
    cooldownItems: 2,
    energyPerDay: 5,
    color: '#CD7F32',
  ...
  },
  {
    ...
    priceUSD: 10,
    durationDays: 30,
    benefits: ['+10 bonus energy/day', '11x tap damage', '1.10x game multiplier', '5 cooldown resets'],
    cooldownItems: 5,
    energyPerDay: 10,
    color: '#C0C0C0',
  ...
  },
  {
    ...
    priceUSD: 20,
    durationDays: 30,
    benefits: ['+20 bonus energy/day', '16x tap damage', '1.15x game multiplier', '10 cooldown resets'],
    cooldownItems: 10,
    energyPerDay: 20,
    color: '#FFD700',
